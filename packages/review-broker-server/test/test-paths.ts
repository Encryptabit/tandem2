...
export const WORKSPACE_REVIEWER_FIXTURE_PATH = 'packages/review-broker-server/test/fixtures/reviewer-worker.mjs';
export const REVIEWER_FIXTURE_RELATIVE_PATH = 'test/fixtures/reviewer-worker.mjs';
export const FIXTURE_PATH = WORKSPACE_REVIEWER_FIXTURE_PATH;
