import { z } from 'zod';
import { ActorIdSchema, AuditEventTypeSchema, ClaimGenerationSchema, CounterPatchStatusSchema, CurrentRoundSchema, IsoDateTimeSchema, ReviewDiscussionMessageSchema, ReviewIdSchema, ReviewPrioritySchema, ReviewStatusSchema, ReviewVerdictSchema, ReviewerOfflineReasonSchema, ReviewerStatusSchema, VerdictReasonSchema, VersionSchema, } from './contracts.js';
import { NOTIFICATION_TOPICS } from './domain.js';
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export const SSE_EVENT_TYPES = ['change', 'heartbeat'];
...
// ---------------------------------------------------------------------------
export const DASHBOARD_NOTIFICATION_TOPICS = NOTIFICATION_TOPICS;
